...
#skat.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/all_tissues/q_values/", tissue, ".skat.q", sep="")
#vt.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/all_tissues/q_values/", tissue, ".vt.q", sep="")
#acat.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/all_tissues/q_values/", tissue, ".acat.q", sep="")
#acat.o.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/all_tissues/q_values/", tissue, ".acat.o.q", sep="")
...
rare.individual.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v8/result_summary/indiv.with.rare.var.idx.non.rv.egenes.only/indiv.with.rare.var.non.rv.egenes", tissue, sep=".")
rare.indiv <- data.frame()

#lrt.rare.z.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/log2.standardized.corrected.tpm/log2.standardized.corrected.lrt.tpm", tissue, sep=".")
#skat.rare.z.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/log2.standardized.corrected.tpm/log2.standardized.corrected.skat.tpm", tissue, sep=".")
#vt.rare.z.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/log2.standardized.corrected.tpm/log2.standardized.corrected.vt.tpm", tissue, sep=".")
#acat.rare.z.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/log2.standardized.corrected.tpm/log2.standardized.corrected.acat.tpm", tissue, sep=".")
#acat.o.rare.z.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v7/sungoohw/result_summary/log2.standardized.corrected.tpm/log2.standardized.corrected.acat.o.tpm", tissue, sep=".")
non.rv.egene.rare.z.file <- paste("/u/project/eeskin2/k8688933/rare_var/results/tss_20k_v8/result_summary/log2.standardized.corrected.tpm.non.rv.egenes.only/log2.standardized.corrected.non.rv.egenes.tpm", tissue, sep=".")
...
non.rv.egene.rare.z <- data.frame()
...
filtered.gene.list <- lapply(gene.list, function(x) {setdiff(x$V1, lrt.q.egene)})
...
for (i in 1:22) {
    ...
    for (selected.gene in filtered.gene.list[[i]]) {
        ...
        non.rv.egene.rare.z <- rbind(non.rv.egene.rare.z, c(selected.gene, E))
        print(warnings())
    }
}
...
#}
if (nrow(non.rv.egene.rare.z) > 0) {
    colnames(non.rv.egene.rare.z) <- c("gene", sample.names)
}
...
write.csv(non.rv.egene.rare.z, non.rv.egene.rare.z.file, quote=F, row.names=F)
